...
for image_path in image_paths:
    ...
    reconstructie_model_path = os.path.join(project_root, "models", "VGAE_final.pt")

    reconstructie_model = torch.load(reconstructie_model_path, map_location=device, weights_only=False)
    reconstructie_model.eval()
